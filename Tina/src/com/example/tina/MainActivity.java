...
public class MainActivity extends SlidingFragmentActivity implements
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		Toast.makeText(MainActivity.this, TinaApplication1.get_dingdanstring(),
		...
		public void handleMessage(Message msg) {
			try {
				if (dingDBManager.getCount() > 0) {
					...
					Toast.makeText(MainActivity.this, "没有喜欢的菜品记录哦！", 1).show();
				}
				ProgressDialog1.dismiss();
			} catch (Exception e) {
				e.printStackTrace();
				ProgressDialog1.dismiss();
				Toast.makeText(MainActivity.this, "网络不给力，无法获得菜品介绍。", 1).show();
				// neterror();//网络重试
			}
		}
	};
